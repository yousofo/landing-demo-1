...
export default function Home() {
  return (
    <main className="home-page relative flex flex-col overflow-hidden">
        ...
        <section className="flex flex-col items-center justify-center gap-4 flex-1 max-w-[700px]">
          <div className="flex flex-col gap-4 items-center md:items-start">
            ...
            <div className="flex items-center gap-2">
              <Link href={"/about"}  className="text-white border border-white py-1 px-5 rounded-sm hover:bg-white hover:text-primary transition-all">
                start now
              </Link>
              <Link  href={"/about"} className="text-white border border-primary py-1 px-5 bg-primary rounded-sm hover:bg-white hover:border-primary hover:text-primary transition-all">
                learn more
              </Link>
            </div>
          </div>
      ...
      <section className="bg-primary text-white p-4">
        <p className="flex flex-col md:flex-row gap-4 md:gap-2 uppercase text-center   items-center justify-center text-inherit">
          ...
          <Link href="/about" className="text-white border border-white py-0.5 px-3 rounded-sm hover:bg-white hover:text-primary transition-all">
            start now
          </Link >
        </p>
      </section>
